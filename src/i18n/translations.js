...
export const translations = {
  en: {
    ...
    'header.themeTitle': 'Theme: {mode} — click to switch',
    ...
    'toolbar.newShapeNoClass': 'Create or select a class first',
  ...
  de: {
    ...
    'header.themeTitle': 'Design: {mode} — zum Wechseln klicken',
    'header.themeSystem': 'Automatisch',
    ...
    'toolbar.newShapeNoClass': 'Lege zuerst eine Klasse an oder wähle eine aus',
